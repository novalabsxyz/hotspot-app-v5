export default {
  ...
  hotspot_setup: {
    ...
    pair: {
      ...
      alert_no_permissions: {
        ...
        body: 'HeliumでBluetoothを使用するにはアクセス許可が必要です。Bluetoothのアクセス許可は「設定」で有効にできます。',
      },
      alert_ble_off: {
        title: 'Bluetoothを有効化',
        body: 'ペアリングを開始するには、Bluetoothをオンにします。登録が完了するまでBluetoothをオンのままにします。',
      },
      scan: 'Hotspotをスキャン',
    },
    ble_scan: {
  ...
  wallet: {
    ...
    intro_slides: [
      ...
      {
        title: 'アカウントのグラフを作成',
        body: '緑色はHNTがアカウントに<green>追加されている</green>ことを示します。',
      },
      {
        title: 'アカウントのグラフを作成',
        body: '青色はHNTがアカウントから<blue>引き出されている</blue>ことを示します。',
      },
    ],
    chartRanges: {
  ...
  more: {
    ...
    sections: {
      ...
      app: {
        ...
        signOutAlert: {
          title: '警告！',
          body: 'アカウントからサインアウトしています。回復用の12個の単語をお持ちですか？お持ちでない場合、以下にアクセスできなくなります。\n\n - Hotspot\n- HNT\n - ウォレット',
        },
      },
    },
  },
  ...
  transfer: {
    ...
    body: 'Hotspotでデータが転送されると、アプリにHotspotが表示されなくなり、このHotspotのHNTを獲得します。\n\n転送を続行するには、下にあるボックスにHotspot名を入力してください。',
    button_title: '転送を続行',
  ...
  checklist: {
    title: 'チェックリスト',
    blocks: {
      not: 'Hotspotはマイニングする前に完全に同期する必要があります。新しいHotspotの同期には最大96時間かかる場合があります。',
    ...
    challenger: {
      ...
      fail: 'HotspotはまだChallengeを発行していません。Hotspotは240ブロックごと（約4時間ごと）にChallengeを自動的に作成します。',
      title: 'Challengeを作成',
    },
    challenge_witness: {
    ...
    witness: {
      ...
      success_plural:
        'このHotspotはウィットネスリストに{{count}}個のHotspotがあります。',
      fail: 'ウィットネスはまだありません。新しいHotspot、および位置情報やアンテナの設定が最近更新されたHotspotのウィットネスはゼロになります。',
      title: 'ウィットネスリスト',
    },
    challengee: {
      success:
      ...
      success_plural:
        'Hotspotは{{count}}ブロック前のChallengeに最後に追加されました。',
      fail: 'オンラインHotspotは240ブロック（4時間）ごとにChallengeが作成され、次にChallengeが作成されるまでに時間がかかる場合があります。',
      title: 'Challengeを渡す',
    },
    data_transfer: {
      success: 'Hotspotは最近データパケットを転送しました。',
      fail: 'Hotspotは自動的にデバイスデータを転送してHNTを獲得します。このHotspotはまだデータを転送していません。',
      title: 'データを転送',
    },
    auto: '自動',
    auto_hours: '数時間ごと',
  ...
  discovery: {
    ...
    begin: {
      ...
      body: '検出モードは1日あたり最大{{requestsPerDay}}セッションで、現時点では無料で使用できます。',
      ...
      location_opts: {
        ...
        info: '*位置情報を設定する前にHotspotのカバレッジをテストしたい場合に便利です',
      },
    },
    results: {
      title: '検出モードの結果',
  ...
  antennas: {
    ...
    elevation_info: {
      title: 'Hotspotの高さ',
      desc: 'アンテナを地面からどのくらいの高さに配置するかを見積もります。平屋家屋の屋根にアンテナを配置する場合、高さは通常、5メートルになります。',
    },
    gain_info: {
      title: 'アンテナのTX/RXゲイン',
      desc: '1から15までの小数点以下1桁の値。これはHotspotまたはアンテナの製造元で確認できます。',
    },
  },
  support_alert: {
    maker: 'ホットスポットのメーカー',
    title: '接触 {{maker}}',
    body: 'お問い合わせください {{maker}} 直接サポートを求め、今後もアプリを使用してください。',
  },
}
