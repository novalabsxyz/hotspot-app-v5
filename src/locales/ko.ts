export default {
  ...
  hotspot_setup: {
    ...
    pair: {
      ...
      alert_no_permissions: {
        title: 'Bluetooth 승인',
        body: 'Helium이 Bluetooth를 사용하려면 권한이 필요합니다. 설정에서 Bluetooth 권한을 활성화할 수 있습니다.',
      },
      alert_ble_off: {
        title: 'Bluetooth 활성화',
        body: '페어링을 시작하려면 Bluetooth를 켜세요. 등록이 완료될 때까지 Bluetooth를 켜두세요.',
      },
      scan: '내 Hotspot 스캔',
    },
    ble_scan: {
  ...
  more: {
    ...
    sections: {
      ...
      app: {
        ...
        signOutAlert: {
          title: '경고!',
          body: '계정에서 로그 아웃합니다. 12개의 복구 단어를 가지고 계십니까? 그렇지 않으면 다음에 대한 액세스 권한을 잃게됩니다:\n\n - Hotspot\n - HNT\n - 지갑',
        },
      },
    },
  },
  ...
  transfer: {
    ...
    body: 'Hotspot이 전송되면 더 이상 앱에서 이 Hotspot을 볼 수 없으며 이 Hotspot에서 HNT를 획득할 수 없습니다.\n\n전송을 계속하려면 아래 상자에 Hotspot 이름을 입력하세요.',
    button_title: '전송 계속',
  ...
  checklist: {
    title: '체크리스트',
    blocks: {
      not: 'Hotspot은 채굴에 앞서 반드시 완전히 동기화되어야 합니다. 새로운 Hotspot은 동기화에 최대 96시간이 소요될 수 있습니다.',
    ...
    challenger: {
      ...
      fail: 'Hotspot이 Challenge를 아직 발행하지 않았습니다. Hotspot은 240 블록 또는 약 4시간마다 자동으로 Challenge를 생성합니다.',
      title: 'Challenge 생성',
    },
    challenge_witness: {
    ...
    witness: {
      ...
      fail: '아직 감시가 없습니다. 새로운 Hotspot이나 최근 위치 또는 안테나 설정이 업데이트된 Hotspot에는 감시가 없습니다.',
      title: '감시 목록',
    },
    challengee: {
      success:
      ...
      success_plural:
        'Hotspot이 블록 {{count}}개 전에 마지막으로 Challenge에 참여했습니다.',
      fail: '온라인 Hotspot은 240 블록(또는 4 시간)마다 Challenge를 받으며 Challenge를 받기까지 다소 시간이 소요될 수 있습니다.',
      title: 'Challenge 통과',
    },
    data_transfer: {
      success: 'Hotspot이 최근 데이터 패킷을 전송했습니다.',
      fail: 'Hotspot이 자동으로 기기 데이터를 전송하고 HNT를 획득합니다. 이 Hotspot은 아직 데이터를 전송하지 않았습니다.',
      title: '데이터 전송',
    },
    auto: '자동',
    auto_hours: '몇 시간마다',
  ...
  discovery: {
    ...
    begin: {
      ...
      body: 'Discovery 모드는 현재 하루에 최대 {{requestsPerDay}} 세션까지 무료로 사용할 수 있습니다.',
      ...
      location_opts: {
        hotspot: '임시 위치 사용*',
        asserted: '확인된 위치 사용',
        info: '*위치를 설정하기 전에 Hotspot 범위를 테스트하려는 경우 유용합니다.',
      },
    },
    results: {
  ...
  antennas: {
    ...
    elevation_info: {
      title: 'Hotspot 높이',
      desc: '안테나가 지면에 비해 얼마나 높은지 추정하세요. 단층집의 지붕에 있는 안테나는 일반적으로 5미터입니다.',
    },
    gain_info: {
      title: '안테나 TX / RX 증가',
