export default {
  ...
  more: {
    ...
    sections: {
      ...
      app: {
        ...
        signOutAlert: {
          title: '警告!',
          body: '您正在注销帐户。您是否记得 12 个助记词?如果忘记了，您将无法再登录:\n\n- 您的 Hotspot\n- 您的 HNT\n- 您的钱包',
        },
      },
    },
  },
  ...
  transfer: {
    ...
    body: '转让 Hotspot 后，您将无法在应用程序中看到此 Hotspot，也无法通过此 Hotspot 赚取 HNT。\n\n要继续转让，请在以下方框中输入 Hotspot 名称。',
    button_title: '继续转让',
  ...
  checklist: {
    title: '检查清单',
    blocks: {
      not: 'Hotspot 必须完全同步后才能挖矿。新 Hotspot 同步最多需要 96 个小时。',
      full: 'Hotspot 已完全同步。',
      partial:
    ...
    challenger: {
      ...
      fail: 'Hotspot 尚未发出 Challenge。Hotspot 每 240 个区块或大约每 4 小时会自动创建 Challenge。',
      title: '创建 Challenge',
    },
    challenge_witness: {
    ...
    witness: {
      ...
      fail: '尚无见证人。新 Hotspot 及近期更新位置或天线设置的 Hotspot 为零见证人。',
      title: '见证人列表',
    },
    challengee: {
      success: 'Hotspot 在 {{count}} 个区块前曾参与过一项 Challenge。',
      success_plural: 'Hotspot 在 {{count}} 个区块前曾参与过一项 Challenge。',
      fail: '在线 Hotspot 每 240 个区块会创建 Challenge，创建过程可能会需要一段时间。',
      title: '通过 Challenge',
    },
    data_transfer: {
